...
const FloatingButton: React.FC<FloatingButtonProps> = ({ onEditProfile, onCapture, onBulkInput, onCalculator, isScoreInputPage }) => {
            ...
            <div style={{ width: '100%', maxWidth: '1400px', position: 'relative', margin: '0 auto' }}>
                <div style={{ position: 'absolute', right: '20px', bottom: '20px', pointerEvents: 'auto', display: 'flex', gap: '10px', alignItems: 'center' }}>
                    {onCalculator && (
                        ...
                        >
                            <span className="mdi mdi-calculator" style={{ fontSize: '20px' }}></span>
                        </button>
                    )}
                    {onCapture && <button
                    ...
                    {onCapture && (
                        ...
                        >
                            <span className="mdi mdi-camera" style={{ fontSize: '20px' }}></span>
                        </button>
                    )}
                    {onEditProfile && (
                        <button
